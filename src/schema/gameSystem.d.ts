...
/**
 * A game system file, data about a system for use with any number of roster building tools
 */
export interface BSDGameSystem {
  /**
   * How to get a hold of the game system's maintaners
   */
  ...
  /**
   * Categories for this game system, automatically imported to every catalogue using it
   */
  categoryEntries?: Category[];
  comment?: string;
  costTypes?: CostTypes;
  /**
   * entryLinks that are available and validated for every force using this game system
   */
  ...
  /**
   * publications that should be listed in every roster using this game system
   */
  ...
  readme?: string;
  /**
   * Incrementing revision number for this game system
   */
  revision: number;
  rules?: Rule[];
  selectionEntries?: SelectionEntry[];
  /**
   * profiles available to any catalogue using this game system
   */
  sharedProfiles?: Profile[];
  /**
   * rules available to any catalogue using this game system
   */
  sharedRules?: Rule[];
  /**
   * selectionEntries available to any catalogue using this game system
   */
  sharedSelectionEntries?: SelectionEntry[];
  /**
   * infoGroups available to any catalogue using this game system
   */
  sharedInfoGroups?: InfoGroup[];
  /**
   * selectionEntryGroups available to any catalogue using this game system
   */
